...
public class Tweet extends Debug {
    ...
    /** Whether this tweet replies to another status. */
    ...
    private TweetInfo getTimelineTweetInfo() throws Exception {
        return new TweetInfo(super.getField("timelineTweetInfo"));
    }
